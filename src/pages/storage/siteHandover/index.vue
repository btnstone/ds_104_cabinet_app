...
const stepItems: StepItem[] = [
  ...
  { title: '接收人确认', component: defineAsyncComponent(() => import('@/components/Cabinet/Inventory/index.vue')) },
...
<template>
  <ContentContainer title="保管格现场交接" user-name="龙傲天" user-id="12315556456">
