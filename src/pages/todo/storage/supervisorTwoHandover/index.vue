...
const stepItems: StepItem[] = [
  { title: '监交人开柜盘点', component: defineAsyncComponent(() => import('@/components/Cabinet/Inventory/index.vue')) },
...
<template>
  <ContentContainer title="保管格预约交接（模式二）监交" user-name="龙傲天" user-id="12315556456">
